...
with open(file_to_load) as election_data:
    ...
    for row in reader:
        ...
        # candidate does not match any existing candidate in the candidate list.
        ...
        if county_name not in county_options:
            ...
            # 4c: Begin tracking that county's vote count.
            county_votes[county_name] = 0
        # 5:Add a vote to that county's count
        county_votes[county_name] += 1

#Save the results to text file.(to terminal)
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (count > lrg_turnout_count):
            lrg_turnout_count = count
    ...
    winning_county_summary = (
        ...
        f"Winning County Vote: {lrg_turnout_count:,}\n"
        f"-------------------------\n\n"
